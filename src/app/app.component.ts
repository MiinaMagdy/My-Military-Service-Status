...
export class AppComponent implements OnInit {
  ...
  timeOffEntries: TimeOff[] = [
    ...
    new TimeOff({
      from: new Date('2025-12-04 00:00:00'),
      to: new Date('2025-12-10 00:00:00'),
    }),
    new TimeOff({
      from: new Date('2025-12-27 00:00:00'),
      to: new Date('2026-01-02 00:00:00'),
    }),
    new TimeOff({
      from: new Date('2026-01-17 00:00:00'),
      to: new Date('2026-01-23 00:00:00'),
    }),
    new TimeOff({
    ...
    new TimeOff({
      from: new Date('2026-02-25 00:00:00'),
      to: new Date('2026-03-02 00:00:00'),
    }),
    new TimeOff({
      from: new Date('2026-03-17 00:00:00'),
      to: new Date('2026-03-20 00:00:00'),
    }),
    new TimeOff({
    ...
    new TimeOff({
      from: new Date('2026-05-23 00:00:00'),
      to: new Date('2026-06-01 00:00:00'),
    })
  ];
